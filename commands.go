...
type Cmdable interface {
	...
	FunctionList(ctx context.Context) *FunctionsListCmd
...
func (c cmdable) FunctionList(ctx context.Context) *FunctionsListCmd {
	cmd := NewFunctionsListCmd(ctx, "function", "list")
	_ = c(ctx, cmd)
	return cmd
}
