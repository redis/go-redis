...
require (
	github.com/redis/go-redis/extra/redisotel/v9 v9.22.0-beta.1
	github.com/redis/go-redis/v9 v9.22.0-beta.1
...
require (
	...
	github.com/redis/go-redis/extra/rediscmd/v9 v9.22.0-beta.1 // indirect
