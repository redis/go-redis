...
func main() {
	...
	fmt.Println("ModeAuto will silently disable the feature.\n")
	...
	fmt.Println("The only difference is that the \"ModeDisabled\" client doesn't send the CLIENT MAINT_NOTIFICATIONS ON command.\n")
