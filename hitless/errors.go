...
var (
	...
	ErrInvalidHandoffWorkers             = errors.New("hitless: MinWorkers must be greater than or equal to 0")
	...
	ErrInvalidHandoffQueueTimeout             = errors.New("hitless: HandoffQueueTimeout must be greater than 0 and less than 1 minute")
	ErrInvalidHandoffRetryDelay               = errors.New("hitless: HandoffRetryDelay must be between 0 and 10 seconds")
	ErrInvalidWorkerScaleDownDelay            = errors.New("hitless: WorkerScaleDownDelay must be between 0 and 5 minutes")
	ErrInvalidWorkerScaleUpDelay              = errors.New("hitless: WorkerScaleUpDelay must be between 0 and 1 minute")
	ErrInvalidWorkerIdleTimeout               = errors.New("hitless: WorkerIdleTimeout must be between 0 and 10 minutes")
