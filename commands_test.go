...
var _ = Describe("Commands", func() {
	...
	Describe("Geo add and radius search", func() {
		...
		It("should search geo radius with options", func() {
			...
			geoRadius := client.GeoRadius(&redis.GeoRadiusQuery{Key: "Sicily", Longitude: "15", Latitude: "37", Radius: "200", Unit: "km", WithHash: true, WithCoord: true, WithDist: true, Count: 2, Sort: "ASC"})
			Expect(geoRadius.Err()).NotTo(HaveOccurred())
		...
		It("should search geo radius with no results", func() {
			...
			geoRadius := client.GeoRadius(&redis.GeoRadiusQuery{Key: "Sicily", Longitude: "99", Latitude: "37", Radius: "200", Unit: "km", WithHash: true, WithCoord: true, WithDist: true})
			Expect(geoRadius.Err()).NotTo(HaveOccurred())
